...
Python), Dash, or Streamlit web applications.
...
in neither Shiny, Dash, nor Streamlit. The web-app wrappers live in framework submodules,
imported explicitly, each behind its own optional dependency:
    ...
    from csiapps.streamlit import page_wrapper             # pip install 'csiapps[streamlit]'
"""
